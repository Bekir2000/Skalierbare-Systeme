<template>
    <div class="container col-lg-6 my-3 border mx-auto" id="app" v-cloak>
    <form @submit.prevent="editTodo()">
            ...
            <div class="form-group">
                ...
                <input type="text" pattern="[0-9]+" class="form-control" name="percent" v-model="percentage" placeholder="XX" required/>
            </div>
...
export default {
  ...
  mounted () {
    ...
    this.todoId = todoId
    if (this.todoId) {
      axios.get(`http://localhost:8004/api/todos/${this.todoId}`)
        .then((response) => {
